<script lang="ts">
	...
	function toggleAppMenuModal(): void {
			...
			<div class=" flex justify-between bg-primarycolor px-4 py-2 dark:bg-darkprimarycolor">
				...
				<div class=" flex pt-0.5 ">
					...
					<svg
						...
						viewBox="0 -1 32 32"
					>
						<a href="https://github.com/RadioRambo/webtools" target="noopener noreferrer">
					...
					{#if !showAppMenu}
						...
						>
							<g clip-path="url(#clip0_103_8)">
								<path d="M14.3164 3.70599H11.3164V6.70599H14.3164V3.70599Z" />
								<path d="M6.81641 3.70599H3.81641V6.70599H6.81641V3.70599Z" />
								<path d="M21.8164 3.70599H18.8164V6.70599H21.8164V3.70599Z" />
								<path d="M14.3164 11.206H11.3164V14.206H14.3164V11.206Z" />
								<path d="M6.81641 11.206H3.81641V14.206H6.81641V11.206Z" />
								<path d="M21.8164 11.206H18.8164V14.206H21.8164V11.206Z" />
								<path d="M14.3164 18.706H11.3164V21.706H14.3164V18.706Z" />
								<path d="M6.81641 18.706H3.81641V21.706H6.81641V18.706Z" />
								<path d="M21.8164 18.706H18.8164V21.706H21.8164V18.706Z" />
							</g>
							<defs>
			...
			>
				<div class="  flex gap-2 sm:gap-4">
					...
					<svg
						...
						xmlns="http://www.w3.org/2000/svg"
					>
						<path d="M17.5 3.75H2.5V5H17.5V3.75Z" />
						<path d="M17.5 15H2.5V16.25H17.5V15Z" />
				...
				<div class="flex justify-between gap-3 sm:gap-3">
					...
					>
						<path
							d="M22.8439 8.88007C22.6426 8.22754 22.3762 7.59687 22.0489 6.99757C21.5649 6.10808 20.9562 5.29233 20.2414 4.57507C18.7729 3.10672 16.902 2.1068 14.8652 1.70174C12.8284 1.29668 10.7173 1.50468 8.79872 2.29943C6.88015 3.09418 5.24034 4.44 4.08663 6.16669C2.93293 7.89338 2.31714 9.92341 2.31714 12.0001C2.31714 14.0767 2.93293 16.1067 4.08663 17.8334C5.24034 19.5601 6.88015 20.9059 8.79872 21.7007C10.7173 22.4955 12.8284 22.7034 14.8652 22.2984C16.902 21.8933 18.7729 20.8934 20.2414 19.4251C20.9562 18.7078 21.5649 17.8921 22.0489 17.0026C22.3762 16.4033 22.6426 15.7726 22.8439 15.1201C23.4762 13.0881 23.4762 10.912 22.8439 8.88007V8.88007ZM3.81638 12.0001C3.81638 9.61312 4.76459 7.32393 6.45242 5.6361C8.14025 3.94828 10.4294 3.00007 12.8164 3.00007V21.0001C10.4294 21.0001 8.14025 20.0519 6.45242 18.364C4.76459 16.6762 3.81638 14.387 3.81638 12.0001V12.0001Z"
						/>
					</svg>
					<!-- Settings Icon -->
					<div>
